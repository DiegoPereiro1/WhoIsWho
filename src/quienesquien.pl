...
personaje(maria / [mujer, pelo_largo, sombrero, pendientes, pelo_castaño, ojos_marrones, boca_pequeña, cejas_finas]).

personaje(claire / [mujer, gafas, sombrero, pelirrojo, ojos_marrones, boca_pequeña]).

personaje(charles / [hombre, bigote, pelo_rubio, ojos_marrones, labios_gruesos, boca_grande, orejas_grandes, raya_al_lado]).

personaje(richard / [hombre, calva, barba, ojos_marrones, orejas_grandes, bigote]).

personaje(eric / [hombre, pelo_rubio, gorra, sombrero, ojos_marrones, boca_grande]).

personaje(alex / [hombre, bigote, pelo_negro, ojos_marrones, boca_grande, labios_gruesos, orejas_grandes, pelo_corto]).

personaje(peter / [hombre, canas, pelo_blanco, nariz_grande, ojos_azules, cejas_gruesas, labios_gruesos, boca_grande, raya_al_lado]).

personaje(philip / [hombre, barba, pelo_negro, ojos_marrones, orejas_grandes, mofletes, mejillas_sonrosadas, cejas_finas, pelo_corto]).

personaje(joe / [hombre, gafas, pelo_rubio, ojos_marrones, boca_pequeña, pelo_corto]).

personaje(paul / [hombre, gafas, pelo_blanco, canas, ojos_marrones, boca_pequeña, orejas_grandes, cejas_gruesas, raya_al_lado]).

personaje(david / [hombre, barba, pelo_rubio, ojos_marrones, orejas_grandes, raya_al_lado]).

personaje(george / [hombre, cara_triste, sombrero, pelo_blanco, canas, ojos_marrones, boca_grande, nariz_pequeña]).

personaje(frans / [hombre, pelo_corto, cejas_gruesas, pelirrojo, ojos_marrones, boca_pequeña]).

personaje(alfred / [hombre, bigote, barba, pelirrojo, ojos_marrones, boca_pequeña, orejas_grandes, pelo_largo, raya_al_medio]).

personaje(bernard / [hombre, pelo_castaño, sombrero, ojos_marrones, boca_pequeña, cejas_finas]).
...
personaje(robert / [hombre, cara_triste, pelo_castaño, ojos_azules, orejas_grandes, nariz_grande, raya_al_lado]).

personaje(anne / [mujer, pelo_corto, pendientes, pelo_negro, ojos_marrones, boca_pequeña]).

personaje(sam / [hombre, gafas, calva, pelo_blanco, canas, boca_pequeña]).

personaje(tom / [hombre, gafas, calva, pelo_negro, boca_pequeña]).
